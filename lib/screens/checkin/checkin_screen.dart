              ...
              BlocBuilder<MeetingBloc, MeetingState>(
                builder: (context, state) {
                  if (state is MeetingLoading) {
                    ...
                    return Center(
                        child: Text('Erro ao carregar reuniões: ${state.message}'));
                  }
              ...
              BlocBuilder<CheckInBloc, CheckInState>(
                builder: (context, checkInState) {
                  ...
                  if (_selectedMeeting == null) {
                    ...
                    statusMessage = 'A reunião selecionada não possui coordenadas de localização. Não é possível fazer check-in.';
                  ...
                  return Column(
                    children: [
                      ...
                      if (checkInState is! CheckInInitial && checkInState is! CheckInLoading && checkInState is! CheckInReadyForShake && checkInState is! CheckInProcessing)
                        const SizedBox(height: 10),
                      if (checkInState is! CheckInInitial && checkInState is! CheckInLoading && checkInState is! CheckInReadyForShake && checkInState is! CheckInProcessing)
                        SizedBox(
                          width: double.infinity,
